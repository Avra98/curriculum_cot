...
CHECKPOINT_ROOT="${CHECKPOINT_ROOT:-${ROOT}/final_checkpoint/sudoku4x4_11empty/baseline}"
OUTPUT_ROOT="${OUTPUT_ROOT:-${CHECKPOINT_ROOT}/${RUN_TAG}/baseline_pipeline_11empty_4stage_4x4}"
...
printf 'Launching 4x4 baseline pipeline on GPUs %s\n' "${GPU_IDS}"
